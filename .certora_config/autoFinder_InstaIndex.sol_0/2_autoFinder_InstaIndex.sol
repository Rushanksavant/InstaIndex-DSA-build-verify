...
contract InstaIndex is CloneFactory {
    ...
    function build(
        ...
        uint256 accountVersion,
        address _origin
    ) public returns (address _account) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010000, 1037618708481) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00011000, _owner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00011001, accountVersion) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00011002, _origin) }
        require(
