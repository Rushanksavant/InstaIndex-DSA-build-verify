...
contract InstaIndex is CloneFactory {
    ...
    function build(
        ...
        uint256 accountVersion,
        address _origin
    ) public returns (address _account) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120000, 1037618708498) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00121000, _owner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00121001, accountVersion) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00121002, _origin) }
        require(
